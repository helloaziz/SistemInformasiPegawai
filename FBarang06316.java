...
public class FBarang06316 extends JFrame implements ActionListener, MouseListener
{
	...
	public FBarang06316() {
		...
		lHrgJual.setBounds (20, 125, 100, 25);
        	lJumlah.setBounds (20, 150, 100, 25);
		...
		fHrgJual.setBounds (115, 125, 100, 25);
		fJumlah.setBounds (115, 150, 125, 25);	
		...
		skrTabel.setBounds(20,185,750,150);
	...
	public static void main(String[] args) {
		new FBarang06316().setVisible(true);
	}
	...
	{ 
		...
		{ 
			...
			String vnhrgjual = String.valueOf(tabel.getValueAt
			...
			fHrgBeli.setText(vnhrgjual);
			fHrgBeli.setText(vjumlah);
	...
	void Add()
	{
		try	
		{
	   		...
	   		String strsqlcr = "SELECT * FROM barang06316 WHERE kode ='" + fKode.getText () + "'";
			...
			if(rs.next())	
			{
	   		...
	   		String strsql = "insert into barang06316(kode, nama, hrgbeli, hrgjual, jumlah) values " +
	...
	int Cari(){
		...
		try	{
			...
			KoneksiDBMS CnPenjualan = new KoneksiDBMS();
	   		...
	   		String strsql = "SELECT * FROM barang06316 WHERE kode ='" + fKode.getText () + "'";
	   		ResultSet rs = stat.executeQuery(strsql);

			if(rs.next())	
			{
				// Jika kode Ditemukan Di Tabel barang06316
	...
	void Koreksi()
	{
		try	
		{
	   		...
	   		String strsql = "update barang06316 set nama='" + fNama.getText()+
	...
	void Hapus()
	{
		try	
		{
	   		...
	   		String strsql = "delete from barang06316 where kode='" + fKode.getText()+"' ";
	   		int stsproses = stat.executeUpdate(strsql);
