...
public class CetakBarangMin06316 extends JFrame implements ActionListener
{
	...
	public static void main(String[] args) {
		new CetakBarangMin06316().setVisible(true);
	}
      ...
      pjob.setPrintable(new Printable() 
      {
		...
		try
		{
			...
			//Koneksi ke table barang..................
	   		...
	   		String strsql = "SELECT * FROM barang06316 where jumlah <= '" + isikanjml + "'";
	   		...
	   		g1.drawString("CV. Udang Telur", 50, 130);        
	   		g1.drawLine(50, 142, 350, 142);
	   		g1.drawString("No.", 50 ,155);
	   		g1.drawString("Kode", 80, 155);
	   		g1.drawString("Nama", 150, 155);
	   		g1.drawString("Harga", 270, 155);
	   		g1.drawString("Jumlah", 310, 155);
	   		g1.drawLine(50, 160, 350, 160);
			g1.drawLine(50, 350, 350, 350);
	   		x1 = 50;
	   		y1 = 190;
	   		i1 = 1;
	   		...
	   		while(rs.next())
	   		{
	   			...
	   			g1.drawString(rs.getString(3),270,y1);
				g1.drawString(rs.getString(5),310,y1);
	   			y1 += 14;
	   			i1++;
